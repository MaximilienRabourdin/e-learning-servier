const slides = [
  ...
  },
  {
    ...
    text: "FC =  92 bpm\nTA bras gauche = 142/87 mmHg\nTA bras droit = 145/82 mmHg\nFR = 22 cpm\nSaO2 = 96 % (air ambiant)\nTempérature = 36,7 °C\n\nSouffle systolique 4/6 au niveau du foyer tricuspide\nÉclat B2 pulmonaire\nChamps pulmonaires libres\nHépatomégalie\nTSVJ (+) RHJ (+)\nŒdèmes des membres inférieurs bilatéraux en chaussette",
    subtext:
  ...
  },
  {
    ...
    subtext: '5-HIAA : acide 5-hydroxy-indol-acétique ; NT-proBNP : N-terminal pro Brain Natriuretic Peptide',
